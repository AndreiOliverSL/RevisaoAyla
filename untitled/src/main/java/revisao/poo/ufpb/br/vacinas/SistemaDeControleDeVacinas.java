...
public interface SistemaDeControleDeVacinas{
    ...
    boolean cadastraPrimeiraDoseDePessoa(String cpf, String tipoVacinaPrimeiraDose, String dataVacinaPrimeiraDose) throws PessoaNaoExisteException;


    boolean cadastraSegundaDoseDePessoa(String cpf, String tipoVacinaSegundaDose, String dataVacinaSegundaDose) throws PessoaNaoExisteException;
